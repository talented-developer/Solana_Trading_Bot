...
var RaydiumSwap = /** @class */ (function () {
    function RaydiumSwap(RPC_URL, WALLET_PRIVATE_KEY) {
        ...
        var secretKeyBuffer = bs58.decode(WALLET_PRIVATE_KEY);
        var secretKeyUint8Array = new Uint8Array(__spreadArray([], secretKeyBuffer, true));
        this.wallet = new anchor_1.Wallet(web3_js_1.Keypair.fromSecretKey(secretKeyUint8Array));
    }
    ...
    RaydiumSwap.prototype.getSwapTransaction = function (toToken_1, amount_1, poolKeys_1) {
        return __awaiter(this, arguments, void 0, function (toToken, amount, poolKeys, maxLamports, useVersionedTransaction, fixedSide) {
    ...
    RaydiumSwap.prototype.sendLegacyTransaction = function (tx, maxRetries) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    RaydiumSwap.prototype.sendVersionedTransaction = function (tx, maxRetries) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        slippage = new raydium_sdk_1.Percent(5, 100);
